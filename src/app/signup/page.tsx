      ...
      <div className="bg-card rounded-2xl shadow-xl p-8 w-full max-w-md flex flex-col gap-6 border border-border">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <input
            ...
            className="bg-background border border-border rounded px-4 py-3 text-text"
          />
          <button type="submit" className="px-6 py-3 rounded-lg bg-primary text-white font-semibold shadow-lg hover:scale-105 transition-all">Sign Up</button>
        </form>
        <button onClick={handleGoogleSignup} className="px-6 py-3 rounded-lg bg-white text-primary font-semibold shadow-lg border border-primary hover:bg-primary hover:text-white transition-all flex items-center justify-center gap-2">
